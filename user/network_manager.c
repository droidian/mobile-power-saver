...
#define NETWORK_MANAGER_DBUS_AP          "org.freedesktop.NetworkManager.AccessPoint"
                     ...
                     GVariant       *value)
{
    ...
    wifi_active = g_strcmp0 (connection_type, "802-11-wireless") == 0;

    if (wifi_active == self->priv->wifi_active)
        return;
